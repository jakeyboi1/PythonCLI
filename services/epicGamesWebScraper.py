...
def viewFreeGamesOfTheWeek():
    req = requests.get('https://store-site-backend-static.ak.epicgames.com/freeGamesPromotions', headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"})
    loadedData = json.loads(req.content)
